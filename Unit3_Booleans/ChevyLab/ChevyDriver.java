...
public class ChevyDriver {
    public static void main(String[] args)
    {
        ...
        traxBase.setMileage(15.0);

        // Set traxLux mileage to 175 with both a luxury and 4WD package
        traxLux.setMileage(175.0);
        traxLux.setLuxStat(true);
        traxLux.setStat4WD(true);
        ...
        if (corvetteSport.compareTo(corvetteClassic) > 0) {
            System.out.println("Classic Corvette at $" + corvetteClassic.getPrice());
        }
        else if (corvetteSport.compareTo(corvetteClassic) < 0) {
        ...
        // *** COMPLETE THE FOLLOWING DECISION STATEMENTS ***
        if (corvetteSport.equalsTo(corvetteClassic))
